...
class AIModelCrawler:
    ...
    async def _extract_model_details(self, url, crawler):
        ...
        browser_cfg = BrowserConfig(headless=False, verbose=True, user_agent=user_agent)
    ...
    async def crawl_models(self):
        ...
        browser_cfg = BrowserConfig(headless=False, verbose=True, user_agent=random.choice(self.user_agents))
